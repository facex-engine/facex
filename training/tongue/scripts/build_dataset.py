...
Output:
   D:/apps/facex/training/data/tongue/train_raw.bin  (N*112*112*3 uint8)
   D:/apps/facex/training/data/tongue/train_labels.bin (N uint8)
   D:/apps/facex/training/data/tongue/meta.json
"""
...
POS_DIR = Path("D:/apps/facex/training/data/tongue/faces_pos")
OUT = Path("D:/apps/facex/training/data/tongue")
